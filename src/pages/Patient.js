...
export const Patient = (props)=>{
    ...
    const [pres, setPrescription]= useState([])
    ...
    const Addpres =(e)=>{
        setPrescription([...pres, prescript])
        e.preventDefault()
        setPrescript('')
        console.log(pres)
    }
...
<button type="button" class="px-6 py-2.5 bg-blue-600 text-white font-medium
  ...
  <form onSubmit={submited}>
    <div class="form-group mb-6">
      <input type="date" class="form-control block
        ...
        placeholder="Date" value={date} onChange={handleDate}/>
    </div>
    <div class="form-group mb-6">
      <textarea
      ...
      id="exampleFormControlTextarea13" rows="3" placeholder="Report"
      value={report} onChange={handleReport}></textarea>
    </div>
    ...
    <button type="submit" class="w-full px-6 py-2.5 bg-blue-600 text-white
...
<HistoryTable history={history} deleteRow={deleteRow}/></>
}