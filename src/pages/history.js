...
const History = ()=>{
  ...
  const addNew = ()=>{
    if(!date || !report )
    {
        // alert('Please Fill (Date & Report) Info')
        open('Please Fill (Date & Report) Info')
        return;
    }
...
const addPrescription= ()=>{
  if(!prescription)
  {
      // alert('Please Fill Prescription (Drug Name) Info')
      open('Please Fill Prescription (Drug Name) Info')
      return;
  }
